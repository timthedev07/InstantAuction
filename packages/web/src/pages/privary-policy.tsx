...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      ...
      <h1>Privacy Policy for Instant Auction</h1>

      <p>
        At Instant Auction, accessible from instantauction.vercel.app, one of
        ...
        Instant Auction and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Instant Auction. This policy is not applicable
      ...
      <p>
        Instant Auction follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Instant Auction uses 'cookies'. These cookies
      ...
      <p>
        ...
        advertising partners of Instant Auction.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Instant Auction, which are sent
      ...
      <p>
        Note that Instant Auction has no access to or control over these cookies
      ...
      <p>
        Instant Auction's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Instant Auction does not knowingly collect any Personal Identifiable
