...
const TermsAndConditions: NextPage = () => {
  return (
    <>
      <Head>
        <title>{metadata.title} | Terms and Conditions</title>
      </Head>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>
      <p>Welcome to Instant Auction!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Instant Auction's Website, located at instantauction.vercel.app.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Instant Auction if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Instant Auction, you agreed
        to use cookies in agreement with the Instant Auction's Privacy Policy.
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Instant Auction and/or its licensors own the
        intellectual property rights for all material on Instant Auction. All
        intellectual property rights are reserved. You may access this from
        Instant Auction for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Instant Auction</li>
        <li>Sell, rent or sub-license material from Instant Auction</li>
        <li>Reproduce, duplicate or copy material from Instant Auction</li>
        <li>Redistribute content from Instant Auction</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Instant Auction does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Instant Auction,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Instant Auction
      ...
      <p>
        Instant Auction reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Instant Auction a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Instant Auction; and (d) the
      ...
      <p>
        ...
        e-mail to Instant Auction. Please include your name, your organization
      ...
      <p>
        No use of Instant Auction's logo or other artwork will be allowed for
